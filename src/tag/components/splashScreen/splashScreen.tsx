...
export const SplashScreen: React.FC<ISplashScreen> = (props) => {
    const {backgroundColor, backgroundImageURI, backgroundVideoURI, logoURI, className, children, ...rest} = props;
    ...
    if(mobile) {
        return (
            ...
            style={backgroundColor ? {backgroundColor: backgroundColor} : backgroundImageURI ? {backgroundImage: `url(${backgroundImageURI})`} : undefined}>
